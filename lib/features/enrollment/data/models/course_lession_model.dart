...
CourseLessonModel courseLessonModelFromJson(String str) =>
    CourseLessonModel.fromJson(json.decode(str));

String courseLessonModelToJson(CourseLessonModel data) =>
...
class Module {
  ...
  Module({this.moduleName, this.lessons});
...
class Navigation {
  ...
  Navigation({this.previousLesson, this.nextLesson});

  factory Navigation.fromJson(Map<String, dynamic> json) => Navigation(
    previousLesson: json["previous_lesson"] == null
        ? null
        : NextLessonClass.fromJson(json["previous_lesson"]),
    nextLesson: json["next_lesson"] == null
        ? null
        : NextLessonClass.fromJson(json["next_lesson"]),
  );
...
class NextLessonClass {
  ...
  NextLessonClass({this.id, this.title});

  factory NextLessonClass.fromJson(Map<String, dynamic> json) =>
      NextLessonClass(id: json["id"], title: json["title"]);
